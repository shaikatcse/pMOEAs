...
import ares.fbk.eu.pMOEA.jmetal.util.comparators.rDominanceComparator;

import java.util.Comparator;
import java.util.HashMap;

/**
 * This class implements an binary tournament selection operator used in rNSGAII
 */
public class rBinaryTournament extends Selection {
   ...
   */
  public rBinaryTournament(HashMap<String, Object> parameters){
  	super(parameters) ;
      ...
      comparator_ = new rDominanceComparator();
  } // BinaryTournament
