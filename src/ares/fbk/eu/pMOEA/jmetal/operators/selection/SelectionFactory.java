...
public class SelectionFactory {
  ...
  public static Selection getSelectionOperator(String name, HashMap parameters) throws JMException {
    ...
    else if (name.equalsIgnoreCase("PreferredTournamentSelection"))
    	return new PreferredTournamentSelection(parameters);
    else if(name.equalsIgnoreCase("rBinaryTournament"))
    	return new rBinaryTournament(parameters);
