...
public class Solution implements Serializable {  
  ...
  //added by shahriar
  private int assignedRegionNumber_;
  
  private double distanceFromclosestRegion_;
  
  private int dominateMeByGP_;
  
  //Shahriar: required for rNSGAII
  private double distanceFromClosestReferencePoint_;
  ...
  public Solution(Problem problem) throws ClassNotFoundException{
    ...
    //shahriar
    distanceFromClosestReferencePoint_ = Double.NEGATIVE_INFINITY;
    //<-
  ...
  public int getNumberOfBits() {
    ...
    for (int i = 0;  i < variable_.length  ; i++)
      if ((variable_[i].getVariableType() ==  ares.fbk.eu.pMOEA.jmetal
.encodings.variable.Binary.class) ||
          (variable_[i].getVariableType() ==  ares.fbk.eu.pMOEA.jmetal
.encodings.variable.BinaryReal.class))
 ...
 //added by Shahriar
 public void setAssignedRegionNumber(int regionNumber){
	  this.assignedRegionNumber_ = regionNumber;
  }
  
 public int getAssignedRegionNumber(){
	  return this.assignedRegionNumber_ ;
  }
  
 public void setDistanceFromCloestRegion(double distanceFromCloestRegion){
	  this.distanceFromclosestRegion_ = distanceFromCloestRegion;
  }
  
 public double getDistanceFromCloestRegion(){
	  return this.distanceFromclosestRegion_;
  } 
  
 public void setDominateMeByGP(int numberOfSoluionsDominateMe){
	  this.dominateMeByGP_ = numberOfSoluionsDominateMe;
 }
 
public int getDominateMeByGP(){
	  return this.dominateMeByGP_ ;
 }

public void setDistanceFromClosestReferencePoint(double dis){
	distanceFromClosestReferencePoint_ = dis;
}

public double getDistanceFromClosestReferencePoint(){
	return distanceFromClosestReferencePoint_;
}
