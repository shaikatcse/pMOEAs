...
public class MOEAD_main {
   ...
   * Usage: three options
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.moead.MOEAD_main
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.moead.MOEAD_main problemName
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.moead.MOEAD_main problemName ParetoFrontFile
