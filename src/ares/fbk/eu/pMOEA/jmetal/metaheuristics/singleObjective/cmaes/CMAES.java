...
.util.PseudoRandom;
import ares.fbk.eu.pMOEA.jmetal
.util.comparators.ObjectiveComparator;
    ...
    if (counteval - eigeneval > lambda /(c1+cmu)/N/10) { // to achieve O(N^2)
      ...
      for (int i = 0; i < N; i++) {
        if (diagD[i] < 0) { // numerical problem?
          System.err.println("ares.fbk.eu.pMOEA.jmetal.metaheuristics.cmaes.CMAES.updateDistribution(): WARNING - an eigenvalue has become negative.");
          counteval = maxEvaluations;
