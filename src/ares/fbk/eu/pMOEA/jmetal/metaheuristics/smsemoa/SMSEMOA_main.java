...
public class SMSEMOA_main {
   ...
   * Usage: three options
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smsemoa.SMSEMOA_main
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smsemoa.SMSEMOA_main problemName
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smsemoa.SMSEMOA_main problemName paretoFrontFile
   */
