...
import ares.fbk.eu.pMOEA.jmetal
.operators.mutation.NonUniformMutation;
import ares.fbk.eu.pMOEA.jmetal
.operators.mutation.UniformMutation;
import ares.fbk.eu.pMOEA.jmetal
.problems.Kursawe;
import ares.fbk.eu.pMOEA.jmetal
...
public class OMOPSO_main {
   ...
   * Usage: three options
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.mocell.MOCell_main
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.mocell.MOCell_main problemName
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.mocell.MOCell_main problemName ParetoFrontFile
   */
