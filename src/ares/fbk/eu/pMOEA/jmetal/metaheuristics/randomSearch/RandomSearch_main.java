...
public class RandomSearch_main {
   ...
   * Usage: three options
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.randomSearch.RandomSearch_main
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.randomSearch.RandomSearch_main problemName
   */
