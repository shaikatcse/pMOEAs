...
public class WASFGA_main {
   ...
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.wasfga.WASFGA_main problemName referencePointFile
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.wasfga.WASFGA_main problemName referencePointFile paretoFrontFile
   *
   * Usage if objectives number is greater than two:
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.wasfga.WASFGA_main problemName referencePointFile weightsDirectory
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.wasfga.WASFGA_main problemName referencePointFile paretoFrontFile weightsDirectory 
   *      
