...
.core.SolutionSet;
import ares.fbk.eu.pMOEA.jmetal
.metaheuristics.gwasfga.GWASFGA;
import ares.fbk.eu.pMOEA.jmetal
...
public class GWASFGA_main {
   ...
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.gwasfga.GWASFGA_main problemName
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.gwasfga.GWASFGA_main problemName paretoFrontFile
   *
   * Usage if objectives number is greater than two:
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.gwasfga.GWASFGA_main problemName weightsDirectory
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.gwasfga.GWASFGA_main problemName paretoFrontFile weightsDirectory 
   * 
