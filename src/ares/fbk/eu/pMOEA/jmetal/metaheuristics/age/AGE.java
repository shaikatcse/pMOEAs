    ...
    public static void main(String[] args) {
        ...
        try {
            if (args.length == 0) {
                ...
                pAGE_main.main(new String[]{"ZDT1", "paretoFronts\\ZDT1.pf", "30", "true", "true", "0.005", "false","9000","BinaryTournament","foo"});   
//              AGE_main.main(new String[]{"WFG1_3D", "originalParetoFronts\\WFG1.3D.pf", "100", "true", "true", "0.01", "false","100000","BinaryTournament","foo"});   
//              AGE_main.main(new String[]{"DTLZ4_3D", "originalParetoFronts\\DTLZ2.3D.1000.pf", "100", "true", "true", "0.01", "false","100000","RandomSelection","foo"});   
            }
            else if (args.length == 7) {
                // in case it is called via the commandline with parameters...
                AGE_main.mainORIG(new String[]{
                            args[0], // problem
