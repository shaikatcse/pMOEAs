...
public class SMPSO_main {
   ...
   * Usage: three options
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.SMPSO_main
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.SMPSO_main problemName
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.SMPSO_main problemName ParetoFrontFile
   */
