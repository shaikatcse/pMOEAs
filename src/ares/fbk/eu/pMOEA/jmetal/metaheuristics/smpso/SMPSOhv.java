...
import ares.fbk.eu.pMOEA.jmetal
.qualityIndicator.fastHypervolume.FastHypervolumeArchive;
import ares.fbk.eu.pMOEA.jmetal
.util.Distance;
import ares.fbk.eu.pMOEA.jmetal
.util.JMException;
...
.util.PseudoRandom;
import ares.fbk.eu.pMOEA.jmetal
.util.comparators.CrowdingDistanceComparator;
import ares.fbk.eu.pMOEA.jmetal
...
public class SMPSOhv extends Algorithm {
  ...
  public SMPSOhv(Problem problem,
    ...
    hy_ = new Hypervolume();
    ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.MetricsUtil mu = new ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.MetricsUtil();
