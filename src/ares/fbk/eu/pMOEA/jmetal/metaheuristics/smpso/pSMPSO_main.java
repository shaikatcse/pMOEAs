...
.util.JMException;
import ares.fbk.eu.pMOEA.jmetal
.util.parallel.IParallelEvaluator;
import ares.fbk.eu.pMOEA.jmetal
.util.parallel.MultithreadedEvaluator;
...
public class pSMPSO_main {
   ...
   * Usage: three options
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.pSMPSO_main
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.pSMPSO_main problemName
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.pSMPSO_main problemName ParetoFrontFile
   */
