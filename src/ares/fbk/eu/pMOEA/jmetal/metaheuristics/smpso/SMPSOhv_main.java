...
public class SMPSOhv_main {
   ...
   * Usage: three options
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.SMPSOhv_main
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.SMPSOhv_main problemName
   *      - ares.fbk.eu.pMOEA.jmetal.metaheuristics.smpso.SMPSOhv_main problemName ParetoFrontFile
   */
