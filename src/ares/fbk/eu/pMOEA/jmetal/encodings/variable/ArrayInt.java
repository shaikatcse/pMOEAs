...
public class ArrayInt extends Variable {
  ...
  public int getValue(int index) throws JMException {
      ...
      Configuration.logger_.severe(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayInt.class+".getValue(): index value (" + index + ") invalid");
      throw new JMException(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayInt.class+": index value (" + index + ") invalid") ;
    } // if
  } // getValue
  ...
  public void setValue(int index, int value) throws JMException {
    if ((index >= 0) && (index < size_))
     ...
     Configuration.logger_.severe(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayInt.class+".setValue(): index value (" + index + ") invalid");
     throw new JMException(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayInt.class+": index value (" + index + ") invalid") ;
    } // else
  } // setValue
	...
	public double getLowerBound(int index) throws JMException {
		if ((index >= 0) && (index < size_))
			...
			Configuration.logger_.severe(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayInt.class+".getLowerBound(): index value (" + index + ") invalid");
			throw new JMException(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayInt.class+".getLowerBound: index value (" + index + ") invalid") ;
		} // else	
	} // getLowerBound
	...
	public double getUpperBound(int index) throws JMException {
		if ((index >= 0) && (index < size_))
			...
			Configuration.logger_.severe(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayInt.class+".getUpperBound(): index value (" + index + ") invalid");
			throw new JMException(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayInt.class+".getUpperBound: index value (" + index + ") invalid") ;
		} // else
	} // getLowerBound
