...
public class ArrayReal extends Variable {
  ...
  public double getValue(int index) throws JMException {
    if ((index >= 0) && (index < size_))
      ...
      Configuration.logger_.severe(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayReal.class + ".getValue(): index value (" + index + ") invalid");
      throw new JMException(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayReal.class + ".ArrayReal: index value (" + index + ") invalid");
    } // if
  } // getValue
  ...
  public void setValue(int index, double value) throws JMException {
    if ((index >= 0) && (index < size_))
      ...
      Configuration.logger_.severe(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayReal.class + ".setValue(): index value (" + index + ") invalid");
      throw new JMException(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayReal.class + ": index value (" + index + ") invalid");
    } // else
  } // setValue
  ...
  public double getLowerBound(int index) throws JMException {
    if ((index >= 0) && (index < size_))
      ...
      Configuration.logger_.severe(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayReal.class + ".getLowerBound(): index value (" + index + ") invalid");
      throw new JMException(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayReal.class + ".getLowerBound: index value (" + index + ") invalid");
    } // else
  } // getLowerBound
  ...
  public double getUpperBound(int index) throws JMException {
    if ((index >= 0) && (index < size_))
      ...
      Configuration.logger_.severe(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayReal.class + ".getUpperBound(): index value (" + index + ") invalid");
      throw new JMException(ares.fbk.eu.pMOEA.jmetal.encodings.variable.ArrayReal.class + ".getUpperBound: index value (" + index + ") invalid");
    } // else
  } // getLowerBound
