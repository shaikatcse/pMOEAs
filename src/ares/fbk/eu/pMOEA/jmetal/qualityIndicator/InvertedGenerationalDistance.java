 ...
 * "java ares.fbk.eu.pMOEA.jmetal.qualityIndicator.InvertedGenerationalDistance <solutionFrontFile> <trueFrontFile> 
...
public class InvertedGenerationalDistance {
  public ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.MetricsUtil utils_;  //utils_ is used to access to the
