 ...
 *  "java ares.fbk.eu.pMOEA.jmetal.qualityIndicator.Spread <solutionFrontFile> <trueFrontFile>". 
...
public class Spread {
  ...
  public static ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.MetricsUtil utils_;//utils_ is used to access to 
  ...
  public double spread(double [][] front, 
    ...
    Arrays.sort(normalizedFront,
    		    new ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.LexicoGraphicalComparator());
