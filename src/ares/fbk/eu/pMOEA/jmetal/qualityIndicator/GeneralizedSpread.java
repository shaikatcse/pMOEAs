 ...
 * $ java ares.fbk.eu.pMOEA.jmetal.qualityIndicator.GeneralizedSpread <solutionFrontFile> <trueFrontFile> <getNumberOfObjectives>
...
public class GeneralizedSpread {
  ...
  public static ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.MetricsUtil utils_;  // MetricsUtil provides some 
  ...
  public GeneralizedSpread() {
    utils_ = new ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.MetricsUtil();
  } // GeneralizedSpread
  ...
  public double generalizedSpread(double [][] paretoFront,
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront,new ares.fbk.eu.pMOEA.jmetal.qualityIndicator.util.LexicoGraphicalComparator());
