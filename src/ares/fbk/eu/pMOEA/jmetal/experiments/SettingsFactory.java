...
public class SettingsFactory {
  ...
  public Settings getSettingsObject(String algorithmName, Object [] params) 
    throws JMException {    
    String base = "ares.fbk.eu.pMOEA.jmetal.experiments.settings." + algorithmName + "_Settings";
    try {
      ...
      Configuration.logger_.severe("SettingsFactory.getSettingsObject: " +
          ...
          "Please, check the algorithm name in ares.fbk.eu.pMOEA.jmetal/metaheuristics") ;
