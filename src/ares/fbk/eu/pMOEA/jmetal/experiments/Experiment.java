...
.core.Algorithm;
import ares.fbk.eu.pMOEA.jmetal
.experiments.util.RBoxplot;
import ares.fbk.eu.pMOEA.jmetal
.experiments.util.RWilcoxon;
import ares.fbk.eu.pMOEA.jmetal
.experiments.util.RunExperiment;
import ares.fbk.eu.pMOEA.jmetal
.experiments.util.Statistics;
import ares.fbk.eu.pMOEA.jmetal
.qualityIndicator.Epsilon;
import ares.fbk.eu.pMOEA.jmetal
.qualityIndicator.Hypervolume;
import ares.fbk.eu.pMOEA.jmetal
.qualityIndicator.InvertedGenerationalDistance;
import ares.fbk.eu.pMOEA.jmetal
...
/**
 * Abstract class representing ares.fbk.eu.pMOEA.jmetal experiments
 */
public abstract class Experiment {
  ...
  //Algorithm[] algorithm_; // ares.fbk.eu.pMOEA.jmetal algorithms to be executed
   ...
   */
  protected void checkParetoFronts() {
   ...
   * @param file
   */
  protected void resetFile(String file) {
   ...
   * @param values
   */
  protected void calculateStatistics(Vector vector,
  ...
  protected void printHeaderLatexCommands(String fileName) throws IOException {
  ...
  protected void printEndLatexCommands(String fileName) throws IOException {
    FileWriter os = new FileWriter(fileName, true);
    os.write("\\end{document}" + "\n");
    os.close();
  } // printEndLatexCommands

  protected void printMeanStdDev(String fileName, int indicator, double[][][] mean, double[][][] stdDev) throws IOException {
    FileWriter os = new FileWriter(fileName, true);
    os.write("\\" + "\n");
  ...
  protected void printMedianIQR(String fileName, int indicator, double[][][] median, double[][][] IQR) throws IOException {
    FileWriter os = new FileWriter(fileName, true);
    os.write("\\" + "\n");
    os.write("\\begin{table}" + "\n");
