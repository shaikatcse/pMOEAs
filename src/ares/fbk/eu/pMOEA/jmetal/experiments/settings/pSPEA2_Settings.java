...
import ares.fbk.eu.pMOEA.jmetal.metaheuristics.spea2.pSPEA2;
import ares.fbk.eu.pMOEA.jmetal
 ...
 */
public class pSPEA2_Settings extends Settings {
   ...
   * Constructor
   */
  public pSPEA2_Settings(String problem) {
    super(problem) ;
