...
public class GWASFGA_Settings extends Settings {
  ...
  public GWASFGA_Settings(String problem) throws JMException {
    super(problem) ;
    String paretoFrontDirectory = new String("/Users/ajnebro/Softw/ares.fbk.eu.pMOEA.jmetal/ares.fbk.eu.pMOEA.jmetalWeb/ares.fbk.eu.pMOEA.jmetalWeb/paretoFronts/");   
