...
package ares.fbk.eu.pMOEA.jmetal.experiments.settings;

import ares.fbk.eu.pMOEA.jmetal.core.Algorithm;
import ares.fbk.eu.pMOEA.jmetal.experiments.Settings;
import ares.fbk.eu.pMOEA.jmetal.metaheuristics.age.AGE;
import ares.fbk.eu.pMOEA.jmetal.operators.crossover.Crossover;
import ares.fbk.eu.pMOEA.jmetal.operators.crossover.CrossoverFactory;
import ares.fbk.eu.pMOEA.jmetal.operators.mutation.Mutation;
 ...
 */
public class AGE_Settings extends Settings {
	...
	public double epsilonGridWidth_;

	/**
	 * Constructor
	 */
	public AGE_Settings(String problem) {
		super(problem);
	...
	public Algorithm configure() throws JMException {
		...
		algorithm.setInputParameter("epsilonGridWidth", epsilonGridWidth_);
	...
	public Algorithm configure(Properties configuration) throws JMException {
		...
		// Selection Operator
		parameters = null;
		// numberOfTournaments_ =
		// Integer.parseInt(configuration.getProperty("numberOfTournaments",String.valueOf(numberOfTournaments_)));
		// String numberOfSolutionPerRegion =
		// configuration.getProperty("numberOfSolutionPerRegion",String.valueOf(numberOfSolutionPerRegion_));
		selection = SelectionFactory.getSelectionOperator("BinaryTournament",
				parameters);
