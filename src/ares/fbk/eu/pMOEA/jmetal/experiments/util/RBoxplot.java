  ...
  public static  void generateScripts(int rows,
    ...
    for (int indicator = 0; indicator <  experiment.indicatorList_.length; indicator++) {
      ...
      for (int i = 0; i <  experiment.algorithmNameList_.length - 1; i++) {
    	  os.write("paste(paste(");
    	  os.write("\"" +  experiment.algorithmNameList_[i] + "\"," + "length(" + experiment.algorithmNameList_[i] + "), sep=\"(\"),\"\", sep=\")\"), " );
      } // for
      os.write("paste(paste(");
      os.write("\"" +  experiment.algorithmNameList_[ experiment.algorithmNameList_.length - 1] + "\"," + "length(" + experiment.algorithmNameList_[ experiment.algorithmNameList_.length - 1] + "), sep=\"(\"),\"\", sep=\")\") )" + "\n");
