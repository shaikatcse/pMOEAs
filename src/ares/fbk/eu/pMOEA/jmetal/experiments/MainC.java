...
public class MainC {
   ...
   * Usage: three options
   *      - ares.fbk.eu.pMOEA.jmetal.experiments.Main algorithmName
   *      - ares.fbk.eu.pMOEA.jmetal.experiments.Main algorithmName problemName
   *      - ares.fbk.eu.pMOEA.jmetal.experiments.Main algorithmName problemName paretoFrontFile
  ...
  public static void main(String [] args) throws
    ...
    if (args.length == 0) { //
      ...
      System.err.println("a) ares.fbk.eu.pMOEA.jmetal.experiments.Main algorithmName ") ;
      System.err.println("b) ares.fbk.eu.pMOEA.jmetal.experiments.Main algorithmName problemName") ;
      System.err.println("c) ares.fbk.eu.pMOEA.jmetal.experiments.Main algorithmName problemName paretoFrontFile") ;
      System.exit(-1) ;
    } // if
