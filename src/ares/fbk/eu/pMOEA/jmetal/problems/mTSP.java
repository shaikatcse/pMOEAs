...
.core.Solution;
import ares.fbk.eu.pMOEA.jmetal
.encodings.solutionType.PermutationSolutionType;
import ares.fbk.eu.pMOEA.jmetal
.encodings.variable.Permutation;
...
public class mTSP extends Problem {
  ...
  */
  public mTSP(String solutionType,
    ...
    //variableType_[0] = Class.forName("ares.fbk.eu.pMOEA.jmetal.base.encodings.variable.Permutation") ;
