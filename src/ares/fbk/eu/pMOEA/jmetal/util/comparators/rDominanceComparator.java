 ...
 * dominance checking and crowding distance (distance from closet reference point), as in rNSGA-II.
 */
public class rDominanceComparator implements Comparator {
   ...
   * @param comparator
   */
  public rDominanceComparator(IConstraintViolationComparator comparator) {
  ...
  */
   ...
   */
    ...
    if (dominate1 == dominate2) {            
      ...
      if(solution1.getDistanceFromClosestReferencePoint() < solution2.getDistanceFromClosestReferencePoint())
    	return -1;
      else if(solution1.getDistanceFromClosestReferencePoint() > solution2.getDistanceFromClosestReferencePoint())
      	return 1;
      else 
    	  return 0;
