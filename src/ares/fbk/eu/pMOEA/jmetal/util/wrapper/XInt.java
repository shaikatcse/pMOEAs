...
.core.SolutionType;
import ares.fbk.eu.pMOEA.jmetal
.encodings.solutionType.ArrayIntSolutionType;
import ares.fbk.eu.pMOEA.jmetal
.encodings.solutionType.IntSolutionType;
import ares.fbk.eu.pMOEA.jmetal
.encodings.variable.ArrayInt;
import ares.fbk.eu.pMOEA.jmetal
.util.Configuration;
import ares.fbk.eu.pMOEA.jmetal
.util.JMException;
  ...
  private XInt() {
	...
	public int getValue(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class){
			...
			Configuration.logger_.severe("ares.fbk.eu.pMOEA.jmetal.util.wrapper.XInt.getValue, solution type " +
					type_ + "+ invalid") ;		
		}
		return 0;
	} // Get value
	...
	public void setValue(int index, int value) throws JMException {
		if (type_.getClass() == IntSolutionType.class)
			...
			Configuration.logger_.severe("ares.fbk.eu.pMOEA.jmetal.util.wrapper.XInt.setValue, solution type " +
					type_ + "+ invalid") ;		
	} // setValue	
	...
	public int getLowerBound(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class)
			...
			Configuration.logger_.severe("ares.fbk.eu.pMOEA.jmetal.util.wrapper.XInt.getLowerBound, solution type " +
					type_ + "+ invalid") ;		
		}
		return 0 ;
	} // getLowerBound
	...
	public int getUpperBound(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class)		
			...
			Configuration.logger_.severe("ares.fbk.eu.pMOEA.jmetal.util.wrapper.XInt.getUpperBound, solution type " +
					type_ + "+ invalid") ;		
	...
	public int getNumberOfDecisionVariables() {
		if (type_.getClass() == IntSolutionType.class)		
			...
			Configuration.logger_.severe("ares.fbk.eu.pMOEA.jmetal.util.wrapper.XInt.size, solution type " +
					type_ + "+ invalid") ;		
		return 0 ;
	} // size
} // XInt